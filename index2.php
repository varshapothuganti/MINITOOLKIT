...
<!-- Wrapper -->
	<div id="wrapper">
		...
		<tr><td align="center"><h4>Convert TEXT TO PDF</h4></td></th>
		<tr>
			<td align="center">
        ...
        <label>Enter Title</label>  
                     ...
                     <br />  
             <label>Enter TEXT to convert into PDF</label>  
             <textarea name="description" class="form-control" rows="10"></textarea>  
             <br />  
             <input type="submit" name="create_word" class="btn btn-info" value="Export to PDF" />  
        </form>  
   </div>
			</td>
		</tr>
